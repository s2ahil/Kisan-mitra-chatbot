    ...
    return (
        <div>
            ...
            <div className='flex gap-5 m-10 flex-wrap justify-center'>
                ...
                <Card name="chatbot for Madhya Pradesh" desc="Tells you about schemes in madhya pradesh" image="https://bep-wordpress.byjusexamprep.com/wp-content/uploads/2023/08/28170756/external-image-7217.jpg" tag1="Madhya pradesh" tag2="Farmers scheme" btnLink="/chat/madhyaPradesh"></Card>
